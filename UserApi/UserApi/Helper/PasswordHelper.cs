...
{
    public static string GenerateRandomPasswordWithDefaultComplexity()
    {
    ...
    private static int GetRandomInt(int fromInclusive, int toExclusive) => RandomNumberGenerator.GetInt32(fromInclusive, toExclusive);
}