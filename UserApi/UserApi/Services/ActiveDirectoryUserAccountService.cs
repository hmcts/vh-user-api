...
{
    public class ActiveDirectoryUserAccountService : IUserAccountService
    {
        ...
        public ActiveDirectoryUserAccountService(ISecureHttpRequest secureHttpRequest, IGraphApiSettings graphApiSettings)
        {
