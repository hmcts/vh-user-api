...
public class Startup(IConfiguration configuration)
{
    ...
    private static void RegisterGraphClient(IServiceCollection services)
    {
        services.AddScoped(sp =>
        {
            ...
            var client = new GraphServiceClient(secretCredential, new[] {aadConfig.GraphApiBaseUri +"/.default"});
            return client;
        });
    }
