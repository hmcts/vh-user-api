...
namespace UserApi.Client
{
    ...
    public partial interface IUserApiClient
    {
        ...
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserForTestResponse>> GetPerformanceTestAccountsAsync(PerformanceTestGroup testGroup);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserForTestResponse>> GetPerformanceTestAccountsAsync(PerformanceTestGroup testGroup, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserForTestResponse>> GetPerformanceTestAccountsAsync(PerformanceTestGroup testGroup)
        {
            return GetPerformanceTestAccountsAsync(testGroup, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserForTestResponse>> GetPerformanceTestAccountsAsync(PerformanceTestGroup testGroup, System.Threading.CancellationToken cancellationToken)
        {
            if (testGroup == null)
                throw new System.ArgumentNullException("testGroup");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "users/PerformanceTestAccounts/{testGroup}"
                    urlBuilder_.Append("users/PerformanceTestAccounts/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(testGroup, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<UserForTestResponse>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new UserApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
