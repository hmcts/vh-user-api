...
namespace UserApi.Client
{
    ...
    public partial interface IUserApiClient
    {
        ...
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserResponse>> GetPerformanceTestAccountsAsync(string testGroup, GetPerformanceTestAccountsRequest request);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserResponse>> GetPerformanceTestAccountsAsync(string testGroup, GetPerformanceTestAccountsRequest request, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserResponse>> GetPerformanceTestAccountsAsync(string testGroup, GetPerformanceTestAccountsRequest request)
        {
            return GetPerformanceTestAccountsAsync(testGroup, request, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserResponse>> GetPerformanceTestAccountsAsync(string testGroup, GetPerformanceTestAccountsRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (testGroup == null)
