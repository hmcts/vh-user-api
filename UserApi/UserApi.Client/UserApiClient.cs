...
namespace UserApi.Client
{
    ...
    public partial class UserApiClient : IUserApiClient
    {
        ...
        /// <summary>Get AD Group For a User</summary>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<GroupsResponse>> GetGroupsForUserAsync(string userId)
        {
        ...
        /// <summary>Get AD Group For a User</summary>
        /// <exception cref="UserApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<GroupsResponse>> GetGroupsForUserAsync(string userId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<GroupsResponse>>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new UserApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
