...
namespace UserApi.UnitTests.Services
{
    public class GetGroupsForUserAsyncTests: UserAccountServiceTests
    {
        ...
        private string Uri => $"{GraphApiSettings.GraphApiBaseUri}v1.0/users/{UserId}/memberOf";
        ...
        { 
            ...
            SecureHttpRequest.Verify(s => s.GetAsync(GraphApiSettings.AccessToken, Uri), Times.Once);
        }
